...
[Download 09-bHC_muder_data.Rdata](../../data/09-bCH_murder_data.Rdata)
...
1. You can save as many named objects as you want in one file! In this case, there are 8 data frames saved in `09-bCH_murder_data.Rdata`
...
Save the `09-bCH_murder_data.Rdata` file to your course directory and edit the file path in the code chunk below as needed to load in the data.
...
load("../../data/09-bCH_murder_data.Rdata")
```
