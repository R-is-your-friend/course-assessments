---
title: "Prepare County Data Lab 8"
execute: 
  echo: true
  message: false
  warning: false
...
Data collected from the [California State Controller](https://counties.bythenumbers.sco.ca.gov/#!/year/default). San Francisco County is excluded.
