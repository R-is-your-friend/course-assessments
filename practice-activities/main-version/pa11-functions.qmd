---
title: "PA 11: Decode the secret numbers"
filters:
  - versions
versions:
  - student:
...
In this activity, you will write several small functions, then use them to 
unscramble a message. Many of the functions have been started for you below, but 
**none** of them are
complete as is.
...
If you have done everything correctly, your final vector will be six numbers long. 
Google these six numbers to find a TV show as your final answer.
